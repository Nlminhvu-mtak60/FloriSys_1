...
namespace FloriSys.DataAccess
{
    ...
    public class BaoCaoRepository
    {
        ...
        public BaoCaoDoanhThu DoanhThuQuy(int quy, int nam)
        {
            return DatabaseHelper.ExecuteSingle<BaoCaoDoanhThu>("sp_BaoCaoDoanhThuQuy", new SqlParameter[]
            {
        ...
        public List<DoanhThuThang> DoanhThuTheoThangTrongQuy(int quy, int nam)
        {
            return DatabaseHelper.ExecuteList<DoanhThuThang>("sp_DoanhThuTheoThangTrongQuy", new SqlParameter[]
            {
                new SqlParameter("@Quy", quy),
                new SqlParameter("@Nam", nam)
            });
