...
namespace FloriSys.DataAccess
{
    public class DatabaseHelper
    {
        private static bool IsInDesignMode
        {
            get
            {
                return System.ComponentModel.LicenseManager.UsageMode == System.ComponentModel.LicenseUsageMode.Designtime
                    || System.Diagnostics.Process.GetCurrentProcess().ProcessName.IndexOf("devenv", StringComparison.OrdinalIgnoreCase) >= 0
                    || System.Diagnostics.Process.GetCurrentProcess().ProcessName.IndexOf("designtoolsserver", StringComparison.OrdinalIgnoreCase) >= 0;
            }
        }
        ...
        {
            if (IsInDesignMode) return new DataTable();
        ...
        {
            if (IsInDesignMode) return prefix + "000000";
